...
import com.longhengrui.oa.callback.ProgressDataCallback;
import com.longhengrui.oa.di.component.DaggerRxOperateComponent;
...
public class RxOperateImpl {
     ...
     * @param <T>
     */
    public <T> void requestFormData(String url, Map<String, String> params, IDataCallBack<T> dataCallBack) {
        if (params == null || params.size() == 0)
     ...
     * @param <T>
     */
    public <T> void requestFormData(String url, HashMap<String, String> headers, IDataCallBack<T> dataCallBack) {
     ...
     * @param <T>
     */
    public <T> void requestFormData(String url, Map<String, String> headers, Map<String, String> params, IDataCallBack<T> dataCallBack) {

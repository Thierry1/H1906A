package com.longhengrui.oa.mvp.model.api;
...
public interface ApiService<T> {
    ...
    @POST
    @FormUrlEncoded
    Observable<ResponseBody> requestFormData(@Url String url, @FieldMap Map<String, String> params);
    

   /*   @POST("user/login")
    @FormUrlEncoded  //像这种post请求 表示form表单，传入参数的接口，表示是form表单，需要此注解
    Call<LoginResultBean> login1(@Field("username") String uname,@Field("password") String passw);*/
